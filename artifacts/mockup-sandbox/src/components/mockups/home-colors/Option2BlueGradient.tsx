...
export default function Option2BluGradient() {
  return (
    <div
      style={{
        width: 390,
    ...
    >
      <div
        style={{
          background: `linear-gradient(160deg, ${PRIMARY_DARK} 0%, ${PRIMARY} 60%, ${ACCENT} 100%)`,
          ...
          {quickActions.map((action) => (
            <div
              ...
              style={{
                ...
                padding: "14px 8px",
                textAlign: "center",
                boxShadow: "0 2px 8px rgba(26,59,173,0.10)",
              }}
            >
      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        <div
          style={{
            ...
            borderRadius: 18,
            padding: 18,
            boxShadow: "0 6px 20px rgba(26,59,173,0.25)",
            color: "#fff",
          }}
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            ...
            <div style={{ fontSize: 11, opacity: 0.8 }}>6:00 م</div>
          </div>

          <div style={{ display: "flex", justifyContent: "space-around", alignItems: "center", marginBottom: 14 }}>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 30, marginBottom: 4 }}>🔵</div>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#fff" }}>الهلال</div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div
                style={{
              ...
              <div style={{ fontSize: 11, opacity: 0.7, marginTop: 4 }}>ملعب الأمير فيصل</div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 30, marginBottom: 4 }}>🟢</div>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#fff" }}>الأهلي</div>
            </div>
          </div>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          ...
          <div style={{ fontSize: 12, color: PRIMARY, fontWeight: 600 }}>عرض الكل</div>
        </div>
          ...
          {groupActivity.map((group) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                gap: 12,
                boxShadow: "0 2px 8px rgba(26,59,173,0.08)",
              }}
            >
              <div
                style={{
          ...
          <div key={tab.label} style={{ textAlign: "center" }}>
            ...
            <div
              style={{
                fontSize: 10,
                marginTop: 2,
                color: tab.active ? PRIMARY_DARK : TEXT_SECONDARY,
