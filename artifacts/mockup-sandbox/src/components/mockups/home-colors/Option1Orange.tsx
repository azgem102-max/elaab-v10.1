...
export default function Option1Orange() {
  return (
    <div
      style={{
        width: 390,
    ...
    >
      <div
        style={{
          background: `linear-gradient(135deg, ${PRIMARY} 0%, #1E3FB5 100%)`,
          ...
          {quickActions.map((action) => (
            <div
              ...
              style={{
                ...
                padding: "14px 8px",
                textAlign: "center",
                boxShadow: "0 2px 8px rgba(44,84,232,0.08)",
              }}
            >
      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        <div
          style={{
            ...
            borderRadius: 18,
            padding: 18,
            boxShadow: "0 4px 16px rgba(44,84,232,0.10)",
          ...
          {groupActivity.map((group) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                gap: 12,
                boxShadow: "0 2px 8px rgba(44,84,232,0.06)",
              }}
            >
              <div
                style={{
